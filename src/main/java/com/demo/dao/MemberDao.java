...
import javaw.core.framework.jdbc.datasource.DynamicDataSource;
import javax.sql.DataSource;

import com.demo.model.Member;
import javaw.core.framework.jdbc.BaseSupportDao;
import javaw.core.framework.jdbc.QueryRule;
...
//	}
	...
	public boolean insert(Member entity) throws Exception{
		...
		Integer id = super.insertAndReturnId(entity);
		entity.setId(id);
		return id > 0;
	}
