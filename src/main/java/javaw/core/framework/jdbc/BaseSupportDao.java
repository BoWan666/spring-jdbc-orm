...
import javaw.core.common.Page;
import javaw.core.common.utils.BeanUtils;
import javaw.core.common.utils.DataUtils;
import javaw.core.common.utils.GenericsUtils;
...
* @Author:         wanbo
* @CreateDate:     2018/10/02 12:40
* @UpdateRemark:
* @Version:        1.0.0
*/
public abstract class BaseSupportDao<T extends Serializable, PK extends Serializable>{
	private Logger log = Logger.getLogger(BaseSupportDao.class);
	...
	/**
	 * @Description 构造，通过super调用时，自动初始化表名、实体、主键等
	 * @Author wanbo
	 **/
	protected BaseSupportDao(){
		try{
